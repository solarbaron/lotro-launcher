...
public:
     ...
     */
    static std::filesystem::path detectSteamPrefix(
     ...
     * 
     * @return Path like <prefix>/drive_c/users/<USER>/Documents/The Lord of the Rings Online
     */
